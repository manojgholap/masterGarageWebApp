...
import Service from '../PeriodicServices/services';
import ScheduleBook from '../GarageBook/ScheduleBook';
import './BkByAdd.css';

const BBGVechicle = (props) => {
    ...
    const isBookByGarage = true

    function getPaymentValue() {
        let payment = 0
        isServiceSelect.forEach((service) => {
                ...
                <>
                    <div>
                        <div className='container-fluid p-0'>
                            <BookADDFirst setGarageSelected={props.setGarageSelected} isGarageSelected={props.isGarageSelected}></BookADDFirst>
                            <br></br>
                            <Service
                                isCarSelect={isCarSelect}
                                isServiceSelect={isServiceSelect}
            ...
            <div className='Re_FirstBox px-5 py-2'>
                ...
                <Row>
                    <Col sm={1} style={{ width: '3%' }}>
                        <Link onClick={() => props.setGarageSelected('')}><svg xmlns="http://www.w3.org/2000/svg" width="20.667" height="20.143" viewBox="0 0 20.667 20.143">
                    ...
                    <Col sm={11} style={{ width: '97%' }}>
                        <Row>
                            <Col sm={1}><img src='http://mastergarage.in/garageapi/packageImage/2.jpg' alt="First choice garage" style={{ width: '77px', height: '77px' }}></img></Col>
                            <Col sm={11}>
                                <Row>
                                    <Col sm={9}><p className="poppins25">{props.isGarageSelected.garageName} <svg xmlns="http://www.w3.org/2000/svg" width="20.268" height="18.566" viewBox="0 0 20.268 18.566">
                                        ...
                                        <Row>
                                            <Col sm={6}>
                                                <p className='poppins15light'><svg xmlns="http://www.w3.org/2000/svg" width="8.279" height="12.766" viewBox="0 0 8.279 12.766">
                                                    ...
                                                    {props.isGarageSelected.garageType}
                                                </p>
                                                <p className='poppins15light'><svg xmlns="http://www.w3.org/2000/svg" width="8.279" height="12.766" viewBox="0 0 8.279 12.766">
                                                    <path id="Icon_metro-location" data-name="Icon metro-location" d="M12.494,1.928a4.067,4.067,0,0,0-4.14,3.989c0,3.989,4.14,8.777,4.14,8.777s4.14-4.787,4.14-8.777a4.067,4.067,0,0,0-4.14-3.989Zm0,6.433A2.491,2.491,0,0,1,9.959,5.918a2.537,2.537,0,0,1,5.071,0A2.491,2.491,0,0,1,12.494,8.361Zm-1.6-2.444a1.605,1.605,0,0,1,3.208,0,1.605,1.605,0,0,1-3.208,0Z" transform="translate(-8.355 -1.928)" fill="#999" />
                                                </svg>
    ...
    <>
        <div className='Re_PartThreeBgBox py-5 px-4'>
            ...
            <Row>
                ...
                <Col sm={6}><img src={`mastergarage.in/garageapi/packageImage/2.jpg`} style={{ width: '145px', height: '99px' }}></img></Col>
            </Row>
