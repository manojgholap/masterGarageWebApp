    ...
    return <>
        ...
        <Row>
                <Col onSubmit={8} className='pt-4'>
                    ...
                    <Link to="/PeriodicService" className="bookgarage1">Book Garage</Link>
                </Col>
            ...
            <Row className='p-4'> 
                <Col lg={8} sm={12}><SubMid props={props} isGarageSelected={isGarageSelected}></SubMid></Col>
                <Col lg={4} sm={12} ><AllGarages setGarageSelected={setGarageSelected} ></AllGarages></Col>
            </Row>
    </div>
    </>
};
const SubMid = (props) =>{
  const [isGarageSelected,setGarageSelected]=useState(props.props.isGarageSelected)
  ...
  const cart=useSelector((state)=>state.check.Cart1)
   ...
   useEffect(()=>{
    ...
    setGarageSelected(props.isGarageSelected)
   },[isGarageSelected])
  //  useEffect(() => {
  //    let count=0;
  //    cart.forEach((item)=>{
  ...
  <text id="Recommended" transform="translate(56 12)" fill="#fff" font-size="11" font-family="SegoeUI, Segoe UI" letter-spacing="0.003em"><tspan x="-36.75" y="0">Recommended</tspan></text>
                    ...
                    <Row>
                        <Col sm={8}>
                        <p className='poppins22B'>{isGarageSelected.garageName||""}</p>
...
{isGarageSelected.garageAddress[0].city+" "+isGarageSelected.garageAddress[0].pincode ||""}</p>
  ...
  <g id="Group_26145" data-name="Group 26145" transform="translate(-728.973 -111)">
    ...
    <path id="Path_22984" data-name="Path 22984" d="M56.129,36.978a9.837,9.837,0,0,1-1.056,4.461,9.978,9.978,0,0,1-8.921,5.517A9.835,9.835,0,0,1,41.691,45.9L35,48.129l2.23-6.691a9.837,9.837,0,0,1-1.056-4.461,9.978,9.978,0,0,1,5.517-8.921A9.838,9.838,0,0,1,46.151,27h.587a9.954,9.954,0,0,1,9.391,9.391Z" transform="translate(717.408 104.436)" fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"/>
                    ...
                    <Row className='py-2 serviceestimate'>
                       {props.props.isGarageSelected.garageAmenities?.map((service)=>{
                         return(
                           <>
                           <Col sm={4}>
                ...
                <div className=''>
                      ...
                      <img src={BasicService} style={{width:'120px',borderRadius:'30%',float:'Left',height:'100px'}}></img>
                          ...
                          <Col sm={8} className='p-0'><p className='poppins18M'>{props.props.isServiceSelect.title}</p>
                          {props.props.isServiceSelect.package.map((item)=>(
                             <p className='poppins12light'>{item}</p>
                             ))
                            } 
                          ...
                          <p className='OpenSans20B py-2'>&#8377; {props.props.isServiceSelect.price}</p>
                          </Col>
                    ...
                    <Row className='px-4 py-2 SecondBoxBorder'>
                                ...
                                <Col sm={6}>
                                <h5 className='OpenSans221' style={{float:'right'}}>&#8377; {props.props.isServiceSelect.price}</h5>
                                </Col>
                                <Row className='pt-4'><Link to="/ScheduleBook" style={{textDecoration:'none'}}><button style={{backgroundColor:'#2650D8',border:'none',height:'50px',borderRadius:'10px',width:'100%',color:'#fff',fontSize:'20px'}}>BOOK GARAGE</button></Link></Row>
